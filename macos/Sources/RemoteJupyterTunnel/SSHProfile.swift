...
struct SSHProfile: Identifiable, Codable, Equatable {
    ...
    init(
        ...
        name: String = "node12 工作区",
        localPort: Int = 8003,
        remoteHost: String = "node12",
        remotePort: Int = 8003,
        jumpUser: String = "zhanghuan",
        jumpHost: String = "www.chenlianfu.com",
        jumpPort: Int = 52922,
        targetUser: String = "zhanghuan",
        targetHost: String = "node12",
        targetPort: Int = 22,
        ...
        allowRemoteLocalPortAccess: Bool = true,
